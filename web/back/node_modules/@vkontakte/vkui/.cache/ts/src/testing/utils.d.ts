...
export declare function mockRect(el: HTMLElement | ({} & any), { x, y, w, h }: RectOptions): void;
export declare const mockScrollContext: (getY: () => number) => [React.FC<{}>, jest.Mock<any, any>];
